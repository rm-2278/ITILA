...
\begin{sol}
    ...
    However, $H(X) = H_2(\eps) \rightarrow 0$ as $\epsilon \rightarrow 0$. \\
    Hence the ensemble with an extremely skewed probability has a difference between the entropy close to 1, which is as big as it gets. 
\end{sol}
