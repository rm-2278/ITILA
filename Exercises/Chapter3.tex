...
\end{prob}
\begin{sol}
    The contestant should (b) switch to door 2. let ``this'' be the event that the prize was in the first choice of door, ``other'' be the event that the prize was in the other unrevelead door, ``evi'' the revealed door being that specific door. Comparing the likelihood ratio, \\
...
\begin{sol}
    \begin{align*}
        P(S_{\text{guilty}} | \text{beaten}, \text{murdered}) &= \frac{P(\text{beaten} | S_{\text{guilty}}, \text{murdered})P(S_{\text{guilty}} | \text{murdered})}{P(\text{beaten} | \text{murdered})} \\
    \end{align*}
    We must compare $P(\text{beaten} | S_{\text{guilty}}, \text{murdered})$ against $P(\text{beaten} | \neg S_{\text{guilty}}, \text{murdered})$ to really conclude how the evidence affects how likely Mr S is guilty. \\
    In fact, $P(\text{beaten} | S_{\text{guilty}}, \text{murdered})$ will likely be much higher, so the lawyer is a slimy trickster. In other words, he quotes the probability of a wife-beater going on to murder his wife, whereas what matters here is the probability that Mr S is the murderer, given both that he beat his wife and that she was in fact murdered.
\end{sol}
\bigskip
